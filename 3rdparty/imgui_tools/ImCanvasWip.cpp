#include "ImCanvasWip.h"

ImCanvasWip::ImCanvasWip() {
...
ImCanvasWip::Config& ImCanvasWip::getConfigRef() {
    return m_Config;
}

float ImCanvasWip::getScale() const {
    return m_Scale;
}

const ImVec2& ImCanvasWip::getOrigin() const {
    return m_Origin;
}

bool ImCanvasWip::isHovered() const {
    return m_Hovered;
}

const ImVec2& ImCanvasWip::getScroll() const {
    return m_Scroll;
}

ImGuiContext* ImCanvasWip::getRawContext() {
    return m_Ctx;
}

ImVec2 ImCanvasWip::screenToCanvas(const ImVec2& vPos) {
...
ImVec2 ImCanvasWip::canvasToScreen(const ImVec2& vPos) {
    if (ImGui::GetCurrentContext() == getRawContext()) {
        return vPos + getScroll();
    }
    return vPos + getOrigin() + getScroll() * getScale();
...
void ImCanvasWip::drawGrid(const GridConfig& vGridConfig) {
...
void ImCanvasWip::m_CopyIOEvents(ImGuiContext* src, ImGuiContext* dst, ImVec2 origin, float scale) {
...
void ImCanvasWip::m_AppendDrawData(ImDrawList* src, ImVec2 origin, float scale) {
