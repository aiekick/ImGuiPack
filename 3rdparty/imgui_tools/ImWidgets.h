...
IMGUI_API bool ContrastedButton(const char* label,
...
IMGUI_API bool InputText_Validation(const char* label,
                                    char* buf,
                                    size_t buf_size,
...
IMGUI_API bool TextureOverLay(float vWidth,
                              ez::texture* vTex,
                              ImVec4 vBorderColor,
...
IMGUI_API bool
SliderUIntDefaultCompact(float width, const char* label, uint32_t* v, uint32_t v_min, uint32_t v_max, uint32_t v_default, uint32_t v_step = 0, const char* format = "%d");
IMGUI_API bool
SliderSizeTDefaultCompact(float width, const char* label, size_t* v, size_t v_min, size_t v_max, size_t v_default, size_t v_step = 0, const char* format = "%d");
IMGUI_API bool
...
IMGUI_API bool
SliderUInt(float width, const char* label, uint32_t* v, uint32_t v_min, uint32_t v_max, uint32_t v_step = 0, const char* format = "%d", ImGuiSliderFlags flags = 0);
IMGUI_API bool
SliderSizeT(float width, const char* label, size_t* v, size_t v_min, size_t v_max, size_t v_step = 0, const char* format = "%zu", ImGuiSliderFlags flags = 0);
IMGUI_API bool SliderFloat(float width,
                           const char* label,
                           float* v,
                           float v_min,
                           float v_max,
...
IMGUI_API bool SliderDouble(float width,
                            const char* label,
                            double* v,
                            double v_min,
                            double v_max,
                            ...
                            ImGuiSliderFlags flags = 0);  // adjust format to decorate the value with a prefix or a
                                                          // suffix for in-slider labels or unit display.
IMGUI_API bool SliderScalarDefault(float width,
                                   const char* label,
                                   ImGuiDataType data_type,
                                   void* p_data,
                                   const void* p_min,
                                   ...
                                   ImGuiSliderFlags flags = 0);
IMGUI_API bool
SliderIntDefault(float width, const char* label, int* v, int v_min, int v_max, int v_default, int v_step = 0, const char* format = "%d", ImGuiSliderFlags flags = 0);
IMGUI_API bool SliderUIntDefault(float width,
                                 const char* label,
                                 uint32_t* v,
                                 uint32_t v_min,
                                 uint32_t v_max,
                                 ...
                                 const char* format = "%d",
                                 ImGuiSliderFlags flags = 0);
IMGUI_API bool SliderSizeTDefault(float width,
                                  const char* label,
                                  size_t* v,
                                  size_t v_min,
                                  size_t v_max,
                                  ...
                                  ImGuiSliderFlags flags = 0);
IMGUI_API bool SliderFloatDefault(float width,
                                  const char* label,
                                  float* v,
                                  float v_min,
                                  float v_max,
...
IMGUI_API bool SliderDoubleDefault(float width,
                                   const char* label,
                                   double* v,
                                   double v_min,
                                   double v_max,
...
IMGUI_API void DisplayAlignedWidget(const float& vWidth, const std::string& vLabel, const float& vOffsetFromStart, std::function<void()> vWidget);
...
IMGUI_API bool BeginContrastedEditCombo(const char* label, char* preview_value, size_t preview_value_size, ImGuiComboFlags flags = 0);
...
IMGUI_API bool ContrastedCombo(float vWidth,
                               const char* label,
                               int* current_item,
...
IMGUI_API bool ContrastedComboVectorDefault(float vWidth,
                                            const char* label,
                                            int* current_item,
                                            const std::vector<std::string>& items,
                                            int vDefault,
                                            int height_in_items = -1);
IMGUI_API bool ContrastedEditCombo(float vWidth,
                                   const char* label,
                                   char* buffer,
                                   size_t buffer_size,
                                   int* current_item,
...
IMGUI_API bool InputFloatDefault(float vWidth,
                                 const char* vName,
                                 float* vVar,
                                 float vDefault,
...
IMGUI_API bool InputDoubleDefault(float vWidth,
                                  const char* vName,
                                  double* vVar,
                                  double vDefault,
                                  const char* vInputPrec = "%.3f",
...
IMGUI_API bool InputFloatDefaultStepper(float vWidth,
                                        const char* vName,
                                        float* vVar,
                                        float vDefault,
                                        float vStep,
                                        ...
                                        const char* vPopupPrec = "%.3f",
                                        bool vShowResetButton = true);
IMGUI_API bool InputDoubleDefaultStepper(float vWidth,
                                         ...
                                         const char* vPopupPrec = "%.3f",
                                         bool vShowResetButton = true);
IMGUI_API bool InputIntDefault(float vWidth, const char* vName, int* vVar, int vDefault, int step = 1, int step_fast = 1);
IMGUI_API bool InputUIntDefault(float vWidth, const char* vName, uint32_t* vVar, uint32_t vDefault, uint32_t step = 1U, uint32_t step_fast = 1U);
