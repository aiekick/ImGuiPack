...
void ImCodeEditor::unit() {
}

void ImCodeEditor::OnImGui() {
...
void ImCodeEditor::SetSelection(int startLine, int startChar, int endLine, int endChar) {
    EZ_TOOLS_DEBUG_BREAK;
    m_Editor.SetCursorPosition(endLine, endChar);
    m_Editor.SelectRegion(startLine, startChar, endLine, endChar);
}

void ImCodeEditor::SetRelatedFile(const std::string& vFile) {
    m_RelatedFile = vFile;
}

const std::string& ImCodeEditor::GetRelatedFile() {
    return m_RelatedFile;
}

void ImCodeEditor::OnFolderViewDeleted(int folderViewId) {
    EZ_TOOLS_DEBUG_BREAK;
...
void ImCodeEditor::SetShowDebugPanel(bool value) {
    EZ_TOOLS_DEBUG_BREAK;
    m_ShowDebugPanel = value;
}

void ImCodeEditor::SetCode(const std::string& vCode, const TextEditor::LanguageDefinition& vType) {
    m_Type = vType;
    m_Editor.SetLanguageDefinition(m_Type);
    m_Editor.SetText(vCode);
    //m_Editor.Render("ImCodeEditor");
}

void ImCodeEditor::ClearErrorMarkers() {
    m_ErrorMarkers.clear();
}

void ImCodeEditor::AddErrorMarker(const size_t& vErrorLine, const std::string& vErrorMsg) {
...
void ImCodeEditor::OnReloadCommand() {
    EZ_TOOLS_DEBUG_BREAK;
...
void ImCodeEditor::OnLoadFromCommand() {
    EZ_TOOLS_DEBUG_BREAK;
...
void ImCodeEditor::OnSaveCommand() {
    EZ_TOOLS_DEBUG_BREAK;
