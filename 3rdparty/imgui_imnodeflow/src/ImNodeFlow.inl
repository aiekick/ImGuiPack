...
inline ImProjectResult ImProjectOnCubicBezier(const ImVec2& point, const ImVec2& p0, const ImVec2& p1, const ImVec2& p2, const ImVec2& p3, const int subdivisions = 100) {
    ...
    for (int i = 0; i < subdivisions; ++i) {
        auto t = i * fixed_step;
        auto p = ImBezierCubicCalc(p0, p1, p2, p3, t);
        auto s = point - p;
        auto d = ImDot(s, s);
